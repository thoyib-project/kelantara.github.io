  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Create Testimoni</h1>
      ...
      <div class="modal-body">
        <form action="{{ url('admin/testimoni') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="exampleInputUsername1" class="fw-bold">Name Customer<span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label for="exampleInputUsername1" class="fw-bold">Testimoni<span class="text-danger">*</span></label>
                <textarea class="ckeditor" value="{{ old('testimoni') }}" style="height: 200px" placeholder="Input Testimoni..." id="floatingTextarea" name="testimoni">{{ old('testimoni') }}</textarea>
                @error('testimoni')
                        <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            <div class="form-group">
                <label for="exampleInputUsername1" class="fw-bold">Image Testimoni<span class="text-danger">*</span></label>
            ...
            <table id="table1">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Name Customer</th>
                        <th style="text-align: center;">Testimoni</th>
                        <th style="text-align: center;">Testimoni Image</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="fw-bold">
                        ...
                        <td class="">
                            ...
                            <div class="modal fade" id="Edit{{$item->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="EditLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="EditLabel">Edit Testimoni</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="{{ url('admin/testimoni', $item->id) }}" method="post" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                @method('PUT')
                                                <div class="form-group">
                                                    <label for="exampleInputUsername1" class="fw-bold">Name Customer<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" value="{{ $item->name }}" id="exampleInputUsername1" placeholder="Input Name Customer..." name="name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputUsername1" class="fw-bold">Testimoni<span class="text-danger">*</span></label>
                                                    <textarea class="ckeditor" value="{{ $item->testimoni }}" style="height: 200px" placeholder="Input Blog Testimoni..." id="floatingTextarea" name="testimoni">{{ $item->testimoni }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputUsername1" class="fw-bold">Testimoni Image<span class="text-danger">*</span></label>
                            ...
                            <form action="{{ url('admin/testimoni', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <td class="text-center">{!!$item->testimoni!!}</td>
                        <td>
