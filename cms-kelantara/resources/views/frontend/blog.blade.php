        ...
        @foreach($blog as $item)
          <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="member d-flex align-items-center">
              <div class="pic"><a href="{{url('/'.$item->slug)}}" class="text-dark">
                <img src="{{asset('img/'.$item->image)}}"  style="height: 18vh;" class="img-fluid" alt=""></a>
            </div>
              <div class="member-info">
                  <a href="{{url('/'.$item->slug)}}" class="text-dark">
                    <h4>{{$item->title}}</h4>
