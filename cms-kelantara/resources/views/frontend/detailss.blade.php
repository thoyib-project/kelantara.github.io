  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          <li><a href="/">Home</a></li>
          <li>Special Service {{$detailserv->title}}</li>
        </ol>
        <h2>Special Service {{$detailserv->title}}</h2>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                @foreach($detailserv->img as $item)
          ...
          <div class="col-lg-12">
            <div class="portfolio-info">
              <h3>Special Service {{$detailserv->title}}</h3>
              <!-- <ul>
